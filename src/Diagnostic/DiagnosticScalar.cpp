...
void DiagnosticScalar::init( Params &params, SmileiMPI *smpi, VectorPatch &vecPatches )
{
    ...
    if( params.geometry != "AMcylindrical" ) {
        ...
        fields.push_back( EMfields->epsilon_->name );
        fields.push_back( EMfields->epsilonx_->name );
        fields.push_back( EMfields->epsilony_->name );
        fields.push_back( EMfields->epsilonz_->name );
        fields.push_back( EMfields->nSurfx_->name );
        fields.push_back( EMfields->nSurfy_->name );
        fields.push_back( EMfields->nSurfz_->name );
