...
public:
    ...
    //! prescribed oscillation amplitude
    double prescribed_amp;
    //! prescribed momentum time profile
    Profile *prescribed_profile;
    //! Constant velocity for massless particles
    double V_const;
    //! atomic number
    ...
    Interpolator *Interp;
    Interpolator *Interp_nSurf;
    //! Interpolator for surface vector
