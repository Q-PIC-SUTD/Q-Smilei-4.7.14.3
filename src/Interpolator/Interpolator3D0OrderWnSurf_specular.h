#ifndef INTERPOLATOR3D0ORDERWNSURF_SPECULAR_H
#define INTERPOLATOR3D0ORDERWNSURF_SPECULAR_H
...
//  --------------------------------------------------------------------------------------------------------------------
class Interpolator3D0OrderWnSurf_specular : public Interpolator3D
{

public:

    //! Creator for Interpolator3D0OrderWnSurf_specular
    Interpolator3D0OrderWnSurf_specular( Params &, Patch * );

    //! Destructor for Interpolator3D0OrderWnSurf_specular
    ~Interpolator3D0OrderWnSurf_specular() override {};
    ...
    inline double __attribute__((always_inline)) compute( double *coeffx, double *coeffy, double *coeffz, double *f, int idx, int idy, int idz, int nx, int ny, int nz )
    {
        ...
        interp_res =  f[ (idx)*ny*nz + (idy)*nz + (idz) ];
        return interp_res;
    };
