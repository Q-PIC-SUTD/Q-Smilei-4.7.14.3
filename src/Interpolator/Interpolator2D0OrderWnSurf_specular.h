#ifndef INTERPOLATOR2D0ORDERWNSURF_SPECULAR_H
#define INTERPOLATOR2D0ORDERWNSURF_SPECULAR_H
...
//  --------------------------------------------------------------------------------------------------------------------
class Interpolator2D0OrderWnSurf_specular : public Interpolator2D
{

public:

    //! Creator for Interpolator2D0OrderWnSurf_specular
    Interpolator2D0OrderWnSurf_specular( Params &, Patch * );

    //! Destructor for Interpolator2D0OrderWnSurf_specular
    ~Interpolator2D0OrderWnSurf_specular() override {};
