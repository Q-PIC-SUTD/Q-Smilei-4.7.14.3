#ifndef INTERPOLATOR3D0ORDERWNSURF_DIFFUSE_H
#define INTERPOLATOR3D0ORDERWNSURF_DIFFUSE_H
...
//  --------------------------------------------------------------------------------------------------------------------
class Interpolator3D0OrderWnSurf_diffuse : public Interpolator3D
{

public:

    //! Creator for Interpolator3D0OrderWnSurf_diffuse
    Interpolator3D0OrderWnSurf_diffuse( Params &, Patch * );

    //! Destructor for Interpolator3D0OrderWnSurf_diffuse
    ~Interpolator3D0OrderWnSurf_diffuse() override {};
