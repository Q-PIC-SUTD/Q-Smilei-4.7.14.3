...
struct PrescribedField { 
    ...
    Profile *profile;
    Profile *time_profile; // used for is_it_uniform=True
    Field *savedField;
...
public:
    ...
    //! Method used to initialize epsilon
    virtual void restartepsilon();
    //! Method used to initialize epsilon
    virtual void restartnSurf();
...
//    virtual void solveMaxwellAmpere() = 0;
    ...
    //! Method used to copy real field and impose an external time fields (apply to all Fields)
    // virtual void applyConstantPrescribedFields(double time);
    //! Method used to copy real field and impose an external time fields (apply to all Fields)
    virtual void initializePrescribedFields( Patch *, double time);
