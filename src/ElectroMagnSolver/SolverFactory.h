...
public:
    ...
    static Solver *createMA( Params &params )
    {
        ...
        if( params.geometry == "1Dcartesian" ) {
            if(params.with_epsilon==true){
                solver = new MA_Solver1D_norm_with_epsilon( params );
            }
            else{
            ...
            } else if(params.with_epsilon==true){
                solver = new MA_Solver2D_norm_with_epsilon( params );
            } else {
            ...
            if( params.is_spectral ) {
                ...
                if( params.is_pxr ) {
                    ...
                    solver = new MA_Solver3D_norm_with_epsilon( params );
                } else {
