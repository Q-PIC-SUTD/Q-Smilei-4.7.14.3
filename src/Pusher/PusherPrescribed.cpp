...
PusherPrescribed::PusherPrescribed( Params &params, Species *species )
    : Pusher( params, species )
{
}

PusherPrescribed::~PusherPrescribed()
{
}
...
void PusherPrescribed::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset,double time )
{
    ...
    */
    ...
    for( int ipart=istart ; ipart<iend; ipart++ ) {
        ...
        */
        ...
        momentum_x[ipart] = prescribed_amp*cos(prescribed_freq*(time-time_frozen_)); // oscillation in x available only
        momentum_y[ipart] = 0;
        momentum_z[ipart] = 0;
