...
PusherBoris_mfp_2D::PusherBoris_mfp_2D( Params &params, Species *species )
    : Pusher( params, species )
{
}

PusherBoris_mfp_2D::~PusherBoris_mfp_2D()
{
}
...
void PusherBoris_mfp_2D::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset , double time)
{
