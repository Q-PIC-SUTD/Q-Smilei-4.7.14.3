...
PusherBoris_2D::PusherBoris_2D( Params &params, Species *species )
    : Pusher( params, species )
{
}

PusherBoris_2D::~PusherBoris_2D()
{
}

/***********************************************************************
    Lorentz Force -- leap-frog (Boris) scheme for 2D material in 3D simulation (vz=0)
***********************************************************************/

void PusherBoris_2D::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset , double time)
{
