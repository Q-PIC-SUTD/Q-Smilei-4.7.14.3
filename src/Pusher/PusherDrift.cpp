...
PusherDrift::PusherDrift( Params &params, Species *species )
    : Pusher( params, species )
{
}

PusherDrift::~PusherDrift()
{
}
...
void PusherDrift::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset , double time)
{
