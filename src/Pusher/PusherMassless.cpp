...
PusherMassless::PusherMassless( Params &params, Species *species )
    : Pusher( params, species )
{
}

PusherMassless::~PusherMassless()
{
}
...
void PusherMassless::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset , double time)
{
